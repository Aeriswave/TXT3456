...
-- **7й** бит для обозначения шрифта:         обычный (=0) или заглавный (=1)   
-- **6й** бит для обозначения высоты букв:    обычная (=0) или высокая (=1)   
-- **5й** бит для обозначения выделения:      без выделения (=0) или жирный (=1)   
...
-- **2й и 1й** биты для обозначения:          цвета символа или расширенного кода используемого шрифта:
