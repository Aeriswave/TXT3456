...
-- **7й** бит зарезервирован

#### НЕ рекомендуется использовать зарезервированный 7й бит для обозначения зачеркивания, т.к. отсечение информации об оформлении повлияет на смысл исходной текстовой информации.
