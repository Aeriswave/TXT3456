...
> 
-- **7й** бит зарезервирован для хранения других дополнительных данных об оформлении и отображении текста.

**НЕ рекомендуется использовать зарезервированный 7й бит для обозначения ~~зачеркивания~~.
