...
Дополнительные преимущества: простое отсечение информации, содержащей информацию об оформлении текста, простое отсечение значимую для смысла передава 
...
-- 0й бит для обозначения высоты букв:    обычная (=0) или высокая (=1)   
