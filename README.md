...
#### НЕ рекомендуется использовать 7-го бита для обозначения зачеркивания, т.к. отсечение информации об оформлении повлияет на смысл исходной текстовой информации.
