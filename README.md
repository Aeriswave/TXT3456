...
-- 0й и 1й биты для обозначения:          цвета символа или расширенного кода используемого шрифта:
> обычный (=00) или GYR (зеленый=01, желтый=10, красный=11).   
> 
-- 2й бит для обозначения шрифта:         обычный (=0) или заглавный (=1)   
-- 3й бит для обозначения высоты букв:    обычная (=0) или высокая (=1)   
-- 4й бит для обозначения выделения:      без выделения (=0) или жирный (=1)   
-- 5й бит для обозначения стиля:          без курсива (=0) или курсив (=1)   
-- 6й бит для обозначения подчеркивания:  без подчеркивания (=0) или с подчеркиванием (=1)   
-- 7й бит зарезервирован:                 без зачеркивания (=0) или с зачеркиванием (=1)

#### зачеркивание НЕ рекомендуется в использовать, т.к. при отсечении информации об оформлении, влияет на смысл исходной текстовой информации.
