...
-- **0й** бит зарезервирован для обозначения дополнительных данных об оформлении и отображении текста
> например,
>     об указании об использовании обычного (=0) или расширенного (=1) набора символов      
>     об использовании латиницы (=0) или кириллицы (=1)
>
