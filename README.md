...
-- **0й** бит зарезервирован для хранения дополнительных данных об оформлении и отображении текста (например, для обозначения ~~зачеркивания~~)
...
**НЕ рекомендуется** в части оформления использовать ~~зачеркивание~~.
**Причина ограничения**: отсечение информации об оформлении поменяет ~~зачёркнутый~~ текст на обычный, что повлияет на смысл исходной текстовой информации.
